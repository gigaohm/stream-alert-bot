...
TWEET_SKELETON = "{custom_name}{1}{twitter_handle_with_at_enclosed}{1}tá on "\
    ...
    "\n\n{twitch_url}\n{twitch_url}"
FULL_EXPECTED_RESULT = "Testing User (@TheTester) tá on na Twitch. O título "\
    "da live é: Testing my live right now !test. Bora!"\
    "\n\ntwitch.tv/thetester\ntwitch.tv/thetester"
NO_CUSTOM_EXPECTED_RESULT = "testing (@TheTester) tá on na Twitch. O título "\
    "da live é: Testing my live right now !test. Bora!"\
    "\n\ntwitch.tv/thetester\ntwitch.tv/thetester"
NO_TWITTER_EXPECTED_RESULT = "Testing User tá on na Twitch. O título da "\
    "live é: Testing my live right now !test. Bora!"\
    "\n\ntwitch.tv/thetester\ntwitch.tv/thetester"
NO_CUSTOM_TWITTER_EXPECTED_RESULT = "testing tá on na Twitch. O título da "\
    "live é: Testing my live right now !test. Bora"\
    "!\n\ntwitch.tv/thetester\ntwitch.tv/thetester"


def test_tweet_message_complete_data(streamer_test_data):
    result = helpers.generate_tweet_message(TWEET_SKELETON,
                                            streamer_test_data())
    print(result)
...
def test_tweet_message_no_optional_data(streamer_test_data):
    result = helpers.generate_tweet_message(TWEET_SKELETON,
                                            streamer_test_data(False, False))
    print(result)
